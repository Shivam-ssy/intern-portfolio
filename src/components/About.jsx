  ...
  return (
    <div >
      <div className="bg-black h-fit">
        <div id="about" className="md:px-16 flex text-white py-10 flex-col items-center md:items-start px-5">
        ...
        <div className="min-h-screen bg-gray-100  text-center py-16">
          ...
          <div className="space-y-4 px-8 md:px-0 gap-5 md:gap-0 mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 mb-20">
            <div>
              <div className="flex items-center">
                <img className="md:h-14  md:w-14 w-10 h-10" src="/design.png" alt="" />
                <h2 className="font-bold -ml-2 text-xl md:text-2xl">Design</h2>
              </div>
              <p className="text-start ml-2 md:ml-10">
            ...
            <div>
              <div className="flex items-center">
                <img className="md:w-14  md:h-14 w-10 h-10" src="/maintenance.png" alt="" />
                <h2 className="font-bold -ml-2 text-xl md:text-2xl">Development</h2>
              </div>
              <p className="text-start ml-2 md:ml-10">
                I can design the site based on your needs and suggestions. I can
                also design the site from scratch and consult you during the
            ...
            <div className="md:col-span-2">
              <div className="flex items-center">
                <img className="md:w-14  md:h-14 w-10 h-10" src="/setting.png" alt="" />
                <h2 className="font-bold -ml-2 text-xl md:text-2xl">Maintenance</h2>
              </div>
              <p className="text-start ml-2 md:ml-10">
                I can design the site based on your needs and suggestions. I can
                also design the site from scratch and consult you during the
